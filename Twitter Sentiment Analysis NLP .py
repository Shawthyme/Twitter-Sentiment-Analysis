...
# CV is most common in NLP upon research, but since the best NB result from Tfidf, I am using Tfidf below.  (I also use CV, and the result is available in the script)
